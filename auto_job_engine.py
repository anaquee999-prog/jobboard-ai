...
from doe_sources import DOE_NEWS_SOURCES
...
USER_AGENT = "JobBoard/1.0 (+https://jobboard-ai-app.onrender.com)"
REQUEST_TIMEOUT = 20

BAD_TITLE_TERMS = [
    "สำนักงานบริหารแรงงานไทยไปต่างประเทศ",
    "สำนักบริหารแรงงานต่างด้าว",
    "เว็บลิงก์หน่วยงานภายนอก",
    "เว็บลิงก์หน่วยงานภายใน",
...
def is_useful_title(title):
    ...
    if any(term.lower() in lowered for term in BAD_TITLE_TERMS):
        return False
...
def save_items(conn, source, items):
    ...
    for item in items:
        ...
        description = (
            ...
            "ผู้หางานควรกดลิงก์ต้นทางเพื่อตรวจสอบรายละเอียดล่าสุด คุณสมบัติ วิธีสมัคร "
            "วันรับสมัคร และเอกสารที่ต้องใช้ก่อนสมัครทุกครั้ง"
        )
